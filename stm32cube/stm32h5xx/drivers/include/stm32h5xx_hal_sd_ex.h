 ...
 * @{
 */
HAL_StatusTypeDef HAL_SDEx_DMALinkedList_ReadBlocks(SD_HandleTypeDef* hsd, SD_DMALinkedListTypeDef const* pLinkedList,
                                                    uint32_t BlockAdd, uint32_t NumberOfBlocks);
HAL_StatusTypeDef HAL_SDEx_DMALinkedList_WriteBlocks(SD_HandleTypeDef* hsd, SD_DMALinkedListTypeDef const* pLinkedList,
                                                     uint32_t BlockAdd, uint32_t NumberOfBlocks);

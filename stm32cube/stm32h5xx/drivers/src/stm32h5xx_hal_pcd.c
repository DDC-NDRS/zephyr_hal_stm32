...
void HAL_PCD_IRQHandler(PCD_HandleTypeDef* hpcd) {
    ...
    if ((wIstr & USB_ISTR_CTR) == USB_ISTR_CTR) {
        ...
        LL_GPIO_SetOutputPin(GPIOB, LL_GPIO_PIN_3); /* DBG_PIN7_HIGH */
        (void)PCD_EP_ISR_Handler(hpcd);
        LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_3); /* DBG_PIN7_LOW */
        return;
    }
        ...
        if (epindex == 0U) {
            ...
            if ((wIstr & USB_ISTR_DIR) == 0U) {
                ...
                if ((wEPVal & USB_EP_SETUP) != 0U) {
                    ...
                    #else
                    LL_GPIO_SetOutputPin(GPIOB, LL_GPIO_PIN_0); /* DBG_PIN0_HIGH */
                    HAL_PCD_SetupStageCallback(hpcd);
                    LL_GPIO_ResetOutputPin(GPIOB, LL_GPIO_PIN_0); /* DBG_PIN0_LOW */
                    #endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
                }

 ...
 * @retval HAL status
 */
uint32_t SDMMC_ReadFIFO(SDMMC_TypeDef const* SDMMCx) {
 ...
 *            - 0x03: Power ON
 */
uint32_t SDMMC_GetPowerState(SDMMC_TypeDef const* SDMMCx) {
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef SDMMC_SendCommand(SDMMC_TypeDef* SDMMCx, SDMMC_CmdInitTypeDef const* Command) {
    uint32_t tmpreg = 0;
 ...
 */
uint8_t SDMMC_GetCommandResponse(SDMMC_TypeDef const* SDMMCx) {
 ...
 */
uint32_t SDMMC_GetResponse(SDMMC_TypeDef const* SDMMCx, uint32_t Response) {
    uint32_t tmp;
 ...
 * @retval HAL status
 */
HAL_StatusTypeDef /**/SDMMC_ConfigData(SDMMC_TypeDef* SDMMCx, SDMMC_DataInitTypeDef const* Data) {
    uint32_t tmpreg = 0;
 ...
 */
uint32_t SDMMC_GetDataCounter(SDMMC_TypeDef const* SDMMCx) {
 ...
 */
uint32_t SDMMC_GetFIFOCount(SDMMC_TypeDef const* SDMMCx) {
    return (SDMMCx->FIFO);
}

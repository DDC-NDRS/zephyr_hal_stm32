...
#define LL_LPTIM_LPTIM2_IC2_RMP_MSIS_4    (LPTIM_CFGR2_IC2SEL_1|LPTIM_CFGR2_IC2SEL_0)  /*!< IC2 connected to MSIS/4 */
/**
  * @}
  */
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_CC1CF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_CC2CF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_CC1OCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_CC2OCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_ARRMCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_EXTTRIGCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_CMP1OKCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_CMP2OKCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_DIEROKCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_ARROKCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_UPCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_DOWNCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_REPOKCF);
}
...
{
  WRITE_REG(LPTIMx->ICR, LPTIM_ICR_UECF);
}

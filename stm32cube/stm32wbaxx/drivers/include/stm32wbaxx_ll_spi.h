...
#ifndef STM32WBAxx_LL_SPI_H
#define STM32WBAxx_LL_SPI_H
...
/** @defgroup SPI_LL_Private_Macros SPI Private Macros
  * @{
  */
#if defined(IS_SPI_GRP1_INSTANCE)
...
/** @defgroup SPI_LL_EC_AUTOCR_TRIGSEL  Autonomous Trigger selection
  ...
  */
#if defined(SPI1)
#define LL_SPI_TRIG_GRP1                   (0x10000000U)                    /*!< Trigger Group for SPI1 */
#endif /* SPI1 */
#define LL_SPI_TRIG_GRP2                   (0x20000000U)                    /*!< Trigger Group for SPI3 */

#if defined(LL_SPI_TRIG_GRP1)
